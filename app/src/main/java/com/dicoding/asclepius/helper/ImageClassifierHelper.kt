...
class ImageClassifierHelper(
    ...
    init {
        try {
            ...
            classifierListener.onError("TensorFlow Lite initialization failed")
...
//        }
//
//        // Load the static image from URI
...
//    }
    ...
    fun classifyStaticImage(image: Bitmap) {
        try {
            if (imageClassifier == null) {
                setupImageClassifier()
            }
            ...
            val errorMessage = "Error during image classification: ${e.message}"
